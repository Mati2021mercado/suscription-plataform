"""
Django settings for suscriptionplatform project.
...
SECRET_KEY = 'django-insecure-&2=4kk7h#x#@-6%+4t@c0=(@y-*b_sulzq%*gvg($%up&3+d7x'
...
# AUTHENTICACION DE USER CUSTOMIZADA
# la clase customizada que creamos en account/models
...
ROOT_URLCONF = 'suscriptionplatform.urls'
...
WSGI_APPLICATION = 'suscriptionplatform.wsgi.application'
